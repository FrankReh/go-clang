// generated by stringer -output=stringer_string.go -type=AccessSpecifier,AvailabilityKind,CallingConv,ChildVisitResult,CommentInlineCommandRenderKind,CommentKind,CommentParamPassDirection,CompletionChunkKind,CompletionContext,ExceptionSpecification,DeclQualifierKind,DiagnosticSeverity,EvalResultKind,IdxAttrKind,IdxDeclInfoFlags,IdxEntityCXXTemplateKind,IdxEntityKind,IdxEntityLanguage,IdxEntityRefKind,IdxObjCContainerKind,IndexOptFlags,LanguageKind,LinkageKind,NameRefFlags,PropertyAttrKind,RefQualifierKind,Reparse_Flags,Result,SaveTranslationUnit_Flags,StorageClass,TemplateArgumentKind,TokenKind,TUResourceUsageKind,TypeKind,VisibilityKind,VisitorResult; DO NOT EDIT
...
const _CompletionContext_name = "CompletionContext_UnexposedCompletionContext_AnyTypeCompletionContext_AnyValueCompletionContext_ObjCObjectValueCompletionContext_ObjCSelectorValueCompletionContext_CXXClassTypeValueCompletionContext_DotMemberAccessCompletionContext_ArrowMemberAccessCompletionContext_ObjCPropertyAccessCompletionContext_EnumTagCompletionContext_UnionTagCompletionContext_StructTagCompletionContext_ClassTagCompletionContext_NamespaceCompletionContext_NestedNameSpecifierCompletionContext_ObjCInterfaceCompletionContext_ObjCProtocolCompletionContext_ObjCCategoryCompletionContext_ObjCInstanceMessageCompletionContext_ObjCClassMessageCompletionContext_ObjCSelectorNameCompletionContext_MacroNameCompletionContext_NaturalLanguageCompletionContext_Unknown"

var _CompletionContext_map = map[CompletionContext]string{
	0:       _CompletionContext_name[0:27],
	1:       _CompletionContext_name[27:52],
	2:       _CompletionContext_name[52:78],
	4:       _CompletionContext_name[78:111],
	8:       _CompletionContext_name[111:146],
	16:      _CompletionContext_name[146:181],
	32:      _CompletionContext_name[181:214],
	64:      _CompletionContext_name[214:249],
	128:     _CompletionContext_name[249:285],
	256:     _CompletionContext_name[285:310],
	512:     _CompletionContext_name[310:336],
	1024:    _CompletionContext_name[336:363],
	2048:    _CompletionContext_name[363:389],
	4096:    _CompletionContext_name[389:416],
	8192:    _CompletionContext_name[416:453],
	16384:   _CompletionContext_name[453:484],
	32768:   _CompletionContext_name[484:514],
	65536:   _CompletionContext_name[514:544],
	131072:  _CompletionContext_name[544:581],
	262144:  _CompletionContext_name[581:615],
	524288:  _CompletionContext_name[615:649],
	1048576: _CompletionContext_name[649:676],
	2097152: _CompletionContext_name[676:709],
	4194303: _CompletionContext_name[709:734],
}

func (i CompletionContext) String() string {
	if str, ok := _CompletionContext_map[i]; ok {
		return str
	}
	return "CompletionContext(" + strconv.FormatInt(int64(i), 10) + ")"
}
...
const (
	_DeclQualifierKind_name_0 = "DeclQualifier_InDeclQualifier_Inout"
	_DeclQualifierKind_name_1 = "DeclQualifier_Out"
	_DeclQualifierKind_name_2 = "DeclQualifier_Bycopy"
	_DeclQualifierKind_name_3 = "DeclQualifier_Byref"
	_DeclQualifierKind_name_4 = "DeclQualifier_Oneway"
)

var (
	_DeclQualifierKind_index_0 = [...]uint8{0, 16, 35}
)

func (i DeclQualifierKind) String() string {
	switch {
	case 1 <= i && i <= 2:
		i -= 1
		return _DeclQualifierKind_name_0[_DeclQualifierKind_index_0[i]:_DeclQualifierKind_index_0[i+1]]
	case i == 4:
		return _DeclQualifierKind_name_1
	case i == 8:
		return _DeclQualifierKind_name_2
	case i == 16:
		return _DeclQualifierKind_name_3
	case i == 32:
		return _DeclQualifierKind_name_4
	default:
		return "DeclQualifierKind(" + strconv.FormatInt(int64(i), 10) + ")"
	}
}
...
const _PropertyAttrKind_name = "PropertyAttr_noattrPropertyAttr_readonlyPropertyAttr_getterPropertyAttr_assignPropertyAttr_readwritePropertyAttr_retainPropertyAttr_copyPropertyAttr_nonatomicPropertyAttr_setterPropertyAttr_atomicPropertyAttr_weakPropertyAttr_strongPropertyAttr_unsafe_unretainedPropertyAttr_class"

var _PropertyAttrKind_map = map[PropertyAttrKind]string{
	0:    _PropertyAttrKind_name[0:19],
	1:    _PropertyAttrKind_name[19:40],
	2:    _PropertyAttrKind_name[40:59],
	4:    _PropertyAttrKind_name[59:78],
	8:    _PropertyAttrKind_name[78:100],
	16:   _PropertyAttrKind_name[100:119],
	32:   _PropertyAttrKind_name[119:136],
	64:   _PropertyAttrKind_name[136:158],
	128:  _PropertyAttrKind_name[158:177],
	256:  _PropertyAttrKind_name[177:196],
	512:  _PropertyAttrKind_name[196:213],
	1024: _PropertyAttrKind_name[213:232],
	2048: _PropertyAttrKind_name[232:262],
	4096: _PropertyAttrKind_name[262:280],
}

func (i PropertyAttrKind) String() string {
	if str, ok := _PropertyAttrKind_map[i]; ok {
		return str
	}
	return "PropertyAttrKind(" + strconv.FormatInt(int64(i), 10) + ")"
}

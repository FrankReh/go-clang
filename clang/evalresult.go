...
func (er EvalResult) IsUnsignedInt() bool {
	return C.clang_EvalResult_isUnsignedInt(er.c) != 0
}
...
// Returns the evaluation result as a constant string if the kind is other than
// Int or float. User must not free this pointer, instead call

...
func (c Cursor) Equal(c2 Cursor) bool {
	return C.clang_equalCursors(c.c, c2.c) != 0
}

// Returns non-zero if cursor is null.
func (c Cursor) IsNull() bool {
	return C.clang_Cursor_isNull(c.c) != 0
}
...
func (c Cursor) HasAttrs() bool {
	return C.clang_Cursor_hasAttrs(c.c) != 0
}
...
func (c Cursor) IsMacroFunctionLike() bool {
	return C.clang_Cursor_isMacroFunctionLike(c.c) != 0
}

// Determine whether a CXCursor that is a macro, is a builtin one.
func (c Cursor) IsMacroBuiltin() bool {
	return C.clang_Cursor_isMacroBuiltin(c.c) != 0
}

// Determine whether a CXCursor that is a function declaration, is an inline declaration.
func (c Cursor) IsFunctionInlined() bool {
	return C.clang_Cursor_isFunctionInlined(c.c) != 0
}
...
func (c Cursor) IsBitField() bool {
	return C.clang_Cursor_isBitField(c.c) != 0
}

// Returns 1 if the base class specified by the cursor with kind CX_CXXBaseSpecifier is virtual.
func (c Cursor) IsVirtualBase() bool {
	return C.clang_isVirtualBase(c.c) != 0
}
...
func (c Cursor) IsCursorDefinition() bool {
	return C.clang_isCursorDefinition(c.c) != 0
}
...
func (c Cursor) IsInvalidDeclaration() bool {
	return C.clang_isInvalidDeclaration(c.c) != 0
}
...
func (c Cursor) IsDynamicCall() bool {
	return C.clang_Cursor_isDynamicCall(c.c) != 0
}
...
func (c Cursor) IsObjCOptional() bool {
	return C.clang_Cursor_isObjCOptional(c.c) != 0
}

// Returns non-zero if the given cursor is a variadic function or method.
func (c Cursor) IsVariadic() bool {
	return C.clang_Cursor_isVariadic(c.c) != 0
}
...
func (c Cursor) IsExternalSymbol() (bool, string, string, bool) {
	...
	return o != 0, language.String(), definedIn.String(), isGenerated != 0
}
...
func (c Cursor) CXXMethod_IsAbstract() bool {
	return C.clang_CXXRecord_isAbstract(c.c) != 0
}

// Determine if an enum declaration refers to a scoped enum.
func (c Cursor) CXXMethod_IsScoped() bool {
	return C.clang_EnumDecl_isScoped(c.c) != 0
}

// Determine if a C++ member function or member function template is declared 'const'.
func (c Cursor) CXXMethod_IsConst() bool {
	return C.clang_CXXMethod_isConst(c.c) != 0
}

...
func _() {
	...
	_ = x[CXXAddrspaceCastExpr-129]
	_ = x[CXXTypeidExpr-130]
	_ = x[CXXBoolLiteralExpr-131]
	_ = x[CXXNullPtrLiteralExpr-132]
	_ = x[CXXThisExpr-133]
	_ = x[CXXThrowExpr-134]
	_ = x[CXXNewExpr-135]
	_ = x[CXXDeleteExpr-136]
	_ = x[UnaryExpr-137]
	_ = x[ObjCStringLiteral-138]
	_ = x[ObjCEncodeExpr-139]
	_ = x[ObjCSelectorExpr-140]
	_ = x[ObjCProtocolExpr-141]
	_ = x[ObjCBridgedCastExpr-142]
	_ = x[PackExpansionExpr-143]
	_ = x[SizeOfPackExpr-144]
	_ = x[LambdaExpr-145]
	_ = x[ObjCBoolLiteralExpr-146]
	_ = x[ObjCSelfExpr-147]
	_ = x[OMPArraySectionExpr-148]
	_ = x[ObjCAvailabilityCheckExpr-149]
	_ = x[FixedPointLiteral-150]
	_ = x[OMPArrayShapingExpr-151]
	_ = x[OMPIteratorExpr-152]
	...
	_ = x[OMPMasterTaskLoopDirective-281]
	_ = x[OMPParallelMasterTaskLoopDirective-282]
	_ = x[OMPMasterTaskLoopSimdDirective-283]
	_ = x[OMPParallelMasterTaskLoopSimdDirective-284]
	_ = x[OMPParallelMasterDirective-285]
	_ = x[OMPDepobjDirective-286]
	_ = x[OMPScanDirective-287]
...
const (
	...
	_Kind_name_3 = ""
	_Kind_name_4 = ""
...
var (
	...
	_Kind_index_3 = [...]uint16{0, 13, 24, 37, 45, 60, 69, 83, 98, 114, 127, 143, 152, 165, 183, 197, 219, 238, 252, 271, 283, 296, 304, 324, 335, 352, 370, 392, 408, 429, 449, 462, 480, 501, 512, 524, 534, 547, 556, 573, 587, 603, 619, 638, 655, 669, 679, 698, 710, 729, 754, 771, 790, 805}
	_Kind_index_4 = [...]uint16{0, 13, 22, 34, 42, 53, 59, 69, 78, 84, 91, 99, 115, 127, 136, 146, 156, 169, 184, 201, 216, 238, 261, 282, 294, 304, 319, 329, 342, 356, 365, 373, 381, 401, 417, 432, 452, 471, 489, 512, 540, 556, 574, 594, 615, 634, 654, 671, 683, 702, 720, 739, 766, 784, 801, 822, 851, 869, 891, 911, 935, 957, 984, 1010, 1036, 1065, 1089, 1122, 1159, 1185, 1218, 1240, 1267, 1298, 1340, 1378, 1401, 1434, 1478, 1526, 1563, 1581, 1607, 1641, 1671, 1709, 1735, 1753, 1769}
